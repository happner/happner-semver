...
(function(isBrowser) {
    ...
    exports.coercedSatisfies = coercedSatisfies;
    function coercedSatisfies(version, range, loose) {
      //exact version match - just return true (1.2.3-prerelease-1 === 1.2.3-prerelease-1)
      if (version === range) return true;
      // coerce: 1.2.3-prerelease-1 -> 1.2.3
      return satisfies(coerce(version), range, loose);
    }
